...
<form action="islem.php" method="post">
    ...
    <select name="hastane" class="hastane">
        ...
        <option value="Bölge Eğitim Ve Araştırma Hastanesi">Trabzon Eğitim Ve Araştırma Hastanesi</option>
        <option value="Akdamar Hastanesi">Ankara Hastanesi</option>
    ...
    <select name="doktor" class="doktor">
        ...
        <option value="Hazar Bilek">Ayşe Karatop</option>
        <option value="Ali Efe">Ali Efe Zorlu</option>
        <option value="Zeynep Altın">Berna Altıntaş</option>
        <option value="Nedim Balat">Burak Kara</option>
    </select>
    <input type="hidden" name="kullanici_id" value="<?php echo $kullanicicek['kullanici_id']; ?>">
    <button name="randevukaydet">Randevu Kaydet</button>
